...
export const TokenMetadataCard = ({address}: {address?: Address}) => {
  ...
  return (
    <div className="border border-border bg-card p-4">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 border border-border flex items-center justify-center text-lg text-purple">
        ...
        <a
          ...
          className="text-dim hover:text-green text-xs"
        >
          [etherscan]
        </a>
      </div>
      ...
      {token.description && (
        <div className="pt-4">
          <p className="text-sm text-dim">{token.description}</p>
        </div>
      )}
      ...
      {(token.website ||
        ...
        token.telegramUrl) && (
        <div className="mt-4 pt-4 border-t border-border">
          <div className="text-xs text-dim mb-3">links</div>
